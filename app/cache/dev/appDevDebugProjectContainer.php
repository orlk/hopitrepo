...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sonata.admin.chambre' => 'getSonata_Admin_ChambreService',
            ...
            'sonata.admin.facture' => 'getSonata_Admin_FactureService',
            ...
            'sonata.admin.patient' => 'getSonata_Admin_PatientService',
            ...
            'users_users.authentication.handler.login_handler' => 'getUsersUsers_Authentication_Handler_LoginHandlerService',
            'users_users.authentication.handler.logout_handler' => 'getUsersUsers_Authentication_Handler_LogoutHandlerService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'hopital22', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Users\\UsersBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\hopital\\MedecinIBundle\\Entity')));

        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\hopital\\MailBundle\\Resources\\config\\doctrine') => 'hopital\\MailBundle\\Entity'));
        $c->setGlobalBasename('mapping');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\FactureBundle\\Resources\\config\\doctrine') => 'FactureBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $e->addDriver($b, 'Users\\UsersBundle\\Entity');
        $e->addDriver($b, 'hopital\\MedecinIBundle\\Entity');
        $e->addDriver($c, 'hopital\\MailBundle\\Entity');
        $e->addDriver($d, 'FactureBundle\\Entity');
        ...
        $f->setEntityNamespaces(array('UsersUsersBundle' => 'Users\\UsersBundle\\Entity', 'MedecinIBundle' => 'hopital\\MedecinIBundle\\Entity', 'mailBundle' => 'hopital\\MailBundle\\Entity', 'FactureBundle' => 'FactureBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a2a72de85720b8cdc25e2babbcad8b9682ae6ea17134d56bc3878fa739447c49');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Users\\UsersBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Users\\UsersBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Users\\UsersBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Users\\UsersBundle\\Entity\\Users');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Users\\UsersBundle\\Entity\\Users');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $f = $this->get('users_users.authentication.handler.login_handler');
        ...
        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('^/wdt/');

        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profiler/');

        $w = new \Symfony\Component\HttpFoundation\RequestMatcher('^/js/');

        $x = new \Symfony\Component\HttpFoundation\RequestMatcher('^/css/');

        $y = new \Symfony\Component\HttpFoundation\RequestMatcher('^/.*');

        $z = new \Symfony\Component\Security\Http\AccessMap();
        $z->add($g, array(0 => 'IS_AUTHENTICATED_REMEMBERED'), NULL);
        ...
        $z->add($k, array(0 => 'ROLE_ADMIN'), NULL);
        ...
        $z->add($t, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $z->add($u, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $z->add($v, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $z->add($w, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $z->add($x, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $z->add($y, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);

        $aa = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $ba = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $aa, $this->get('users_users.authentication.handler.logout_handler'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $ba->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($z, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $ba, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $e, $this->get('security.authentication.session_strategy'), $aa, 'main', $f, $f, array('use_forward' => false, 'check_path' => '/login_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '55c8ef3f5be07', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $z, $e)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $aa, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $aa, '/login', false), NULL, NULL, $a));
    }
    ...
    /**
     * Gets the 'sonata.admin.chambre' service.
     *
     * @return \Users\UsersBundle\Admin\ChambreAdmin A Users\UsersBundle\Admin\ChambreAdmin instance.
     */
    protected function getSonata_Admin_ChambreService()
    {
        $instance = new \Users\UsersBundle\Admin\ChambreAdmin('sonata.admin.chambre', 'Users\\UsersBundle\\Entity\\Chambre', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('UsersUsersBundle');
    ...
    /**
     * Gets the 'sonata.admin.facture' service.
     *
     * @return \Users\UsersBundle\Admin\FactureAdmin A Users\UsersBundle\Admin\FactureAdmin instance.
     */
    protected function getSonata_Admin_FactureService()
    {
        $instance = new \Users\UsersBundle\Admin\FactureAdmin('sonata.admin.facture', 'Users\\UsersBundle\\Entity\\Facture', 'SonataAdminBundle:CRUD');
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('gestion des factures');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataAdminBundle:Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'UsersUsersBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array());
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.patient' service.
     *
     * @return \Users\UsersBundle\Admin\PatientAdmin A Users\UsersBundle\Admin\PatientAdmin instance.
     */
    protected function getSonata_Admin_PatientService()
    {
        $instance = new \Users\UsersBundle\Admin\PatientAdmin('sonata.admin.patient', 'Users\\UsersBundle\\Entity\\Patient', 'SonataAdminBundle:CRUD');
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('gestion des pations');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataAdminBundle:Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'UsersUsersBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array());
        $instance->initialize();
     ...
     *
     * @return \Users\UsersBundle\Admin\AdminsAdmin A Users\UsersBundle\Admin\AdminsAdmin instance.
     */
    protected function getSonata_Admin_PostService()
    {
        $instance = new \Users\UsersBundle\Admin\AdminsAdmin('sonata.admin.post', 'Users\\UsersBundle\\Entity\\Users', 'SonataAdminBundle:CRUD');
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('gestion des Comptes');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataAdminBundle:Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'UsersUsersBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array());
        $instance->initialize();
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.post', 1 => 'sonata.admin.patient', 2 => 'sonata.admin.chambre', 3 => 'sonata.admin.facture'), $this);
    }
    ...
    {
        return $this->services['sonata.block.loader.service'] = new \Sonata\BlockBundle\Block\Loader\ServiceLoader(array(0 => 'sonata.admin.block.admin_list', 1 => 'sonata.admin.block.search_result', 2 => 'sonata.block.service.text', 3 => 'sonata.block.service.rss'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('a.h.hichem@gmail.com@');
        $a->setPassword('h3ceeh1989');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Users\\UsersBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\hopital\\MedecinIBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\hopital\\MailBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\hopital\\MedecinIBundle/Resources/views'), 'MedecinI');
        $instance->addPath(($this->targetDirs[3].'\\src\\hopital\\MailBundle/Resources/views'), 'mail');
        $instance->addPath(($this->targetDirs[3].'\\src\\FactureBundle/Resources/views'), 'Facture');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ddb73266eeb2e96b85109a4164a5d1d4c');
    }

    /**
     * Gets the 'users_users.authentication.handler.login_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Users\UsersBundle\Authentication\Handler\LoginHandler A Users\UsersBundle\Authentication\Handler\LoginHandler instance.
     */
    protected function getUsersUsers_Authentication_Handler_LoginHandlerService()
    {
        return $this->services['users_users.authentication.handler.login_handler'] = new \Users\UsersBundle\Authentication\Handler\LoginHandler($this->get('router'), $this->get('security.context'), $this->get('translator.default'));
    }

    /**
     * Gets the 'users_users.authentication.handler.logout_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Users\UsersBundle\Authentication\Handler\LogoutHandler A Users\UsersBundle\Authentication\Handler\LogoutHandler instance.
     */
    protected function getUsersUsers_Authentication_Handler_LogoutHandlerService()
    {
        return $this->services['users_users.authentication.handler.logout_handler'] = new \Users\UsersBundle\Authentication\Handler\LogoutHandler($this->get('router'));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_client' => array(0 => 'ROLE_CLIENT'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_SONATA_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MedecinIBundle' => 'hopital\\MedecinIBundle\\MedecinIBundle',
                'mailBundle' => 'hopital\\MailBundle\\mailBundle',
                'FactureBundle' => 'FactureBundle\\FactureBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'hopital22',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'a.h.hichem@gmail.com',
            'mailer_password' => 'h.hichem@1989',
            'locale' => 'fr',
            'secret' => 'ddb73266eeb2e96b85109a4164a5d1d4c',
            'debug_toolbar' => true,
            ...
            'kernel.secret' => 'ddb73266eeb2e96b85109a4164a5d1d4c',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'a.h.hichem@gmail.com@',
            'swiftmailer.mailer.default.transport.smtp.password' => 'h3ceeh1989',
            ...
            'fos_user.model.user.class' => 'Users\\UsersBundle\\Entity\\Users',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'registration@Hoptalplus.com' => 'hopital plus Registration',
            ),
            ...
            'sonata.admin.configuration.dashboard_blocks' => array(
                ...
                1 => array(
                    ...
                    'settings' => array(
                        'content' => '<h2>Bienvenu dans le system administratif</h2> <p>i5dim 3ala rouhik <code>ma5ir tbalfit</code>
',
                    ),
                    'class' => 'col-md-4',
                ),
